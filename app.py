...
# -------------------------
# Load scalers (NO retraining in deployment)
# -------------------------
...
# Streamlit UI
# -------------------------
st.title("📈 AAPL Stock Price Prediction (LSTM)")
st.write("Next-day stock price prediction using trained PyTorch LSTM model.")
...
if st.button("Predict Next-Day Price"):
    ...
    next_day_price = preds[-1][0]

    st.metric(
        label="Predicted Next-Day AAPL Price",
